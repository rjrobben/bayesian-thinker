...
<p>I observe that my brain is always generating thoughts or beliefs or imagenry where something bad is happening that might acutally be unlikely to occur.
    I want to use a Bayesian way to assess the reasonableness of these thoughts and beliefs.
    And I want to be able to see a log of what I am usually ruminating on.
</p>


<h2>Usage</h2>
<p>
    You can view your analysis in "Combined Events Tab".
</p>